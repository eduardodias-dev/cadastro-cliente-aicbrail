...
jQuery(function() {
    try{
        ...
        var interval = setInterval(carouselLoop, 5000);
        ...
        document.querySelector('.mySiema').addEventListener('mousein', function(){
            console.log('out')
    
            clearInterval(interval);
        });
    
        document.querySelector('.mySiema').addEventListener('mouseout', function(){
            clearInterval(interval);
            console.log('out')
            interval = setInterval(carouselLoop, 5000);
        });
    }catch(e){}
